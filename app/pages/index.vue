<template>
  <main class="w-full max-w-[1240px] mx-auto flex flex-col gap-16">
    <AppCharacterSection :characters="characters" />
    <AppEpisodeSection :episodes="episodes" />
  </main>
</template>
...
const characters = computed(() => charactersData.map(item => ({
  id: item.id,
  name: item.name,
  image: item.image,
  status: item.status,
